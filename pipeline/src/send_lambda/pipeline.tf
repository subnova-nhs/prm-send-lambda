...
resource "aws_iam_role" "pipeline_role" {
  name               = "prm-send-lambda-pipeline-${var.environment}"
...
resource "aws_codepipeline" "pipeline" {
  name     = "prm-send-lambda-${var.environment}"
  ...
  stage {
    ...
    action {
      ...
      configuration {
        ...
        Extract = "true"
        ObjectKey = "prm-send-lambda-${var.environment}/outputs"
      }
    }
  }
}
